...
SSLv2 etc.) -- all the dirty features needed fopr testing. OTOH the binaries also come with extended support for new / advanced cipher suites and/or features which are not (yet?) in the official branch.
