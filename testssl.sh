...
STARTTLS_SLEEP=${STARTTLS_SLEEP:-1}     # max time to wait on a socket reply for STARTTLS
STARTTLS_SLEEP_TARPIT=${STARTTLS_SLEEP_TARPIT:-${STARTTLS_SLEEP}}	# max time to wait on a socket reply for single-byte STARTTLS reads
