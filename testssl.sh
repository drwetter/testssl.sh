...
EOF
     ...
     cat >$CIPHERS_BY_STRENGTH_FILE << EOF
      0xCC,0x14 - ECDHE-ECDSA-CHACHA20-POLY1305  TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_SHA256 TLSv1.2    Kx=ECDH        Au=ECDSA   Enc=ChaCha20(256)              Mac=AEAD               
      0xCC,0x13 - ECDHE-RSA-CHACHA20-POLY1305    TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256   TLSv1.2    Kx=ECDH        Au=RSA     Enc=ChaCha20(256)              Mac=AEAD               
      0xCC,0x15 - DHE-RSA-CHACHA20-POLY1305      TLS_DHE_RSA_WITH_CHACHA20_POLY1305_SHA256     TLSv1.2    Kx=DH          Au=RSA     Enc=ChaCha20(256)              Mac=AEAD               
      ...
      0xCC,0xA9 - ECDHE-ECDSA-CHACHA20-POLY1305  TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305        TLSv1.2    Kx=ECDH        Au=ECDSA   Enc=CHACHA20/POLY1305(256)     Mac=AEAD               
      0xCC,0xA8 - ECDHE-RSA-CHACHA20-POLY1305    TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305          TLSv1.2    Kx=ECDH        Au=RSA     Enc=CHACHA20/POLY1305(256)     Mac=AEAD               
      0xCC,0xAA - DHE-RSA-CHACHA20-POLY1305      TLS_DHE_RSA_WITH_CHACHA20_POLY1305            TLSv1.2    Kx=DH          Au=RSA     Enc=CHACHA20/POLY1305(256)     Mac=AEAD               
      ...
      0xCC,0xAE - RSA-PSK-CHACHA20-POLY1305      TLS_RSA_PSK_WITH_CHACHA20_POLY1305            TLSv1.2    Kx=RSAPSK      Au=RSA     Enc=CHACHA20/POLY1305(256)     Mac=AEAD               
      0xCC,0xAD - DHE-PSK-CHACHA20-POLY1305      TLS_DHE_PSK_WITH_CHACHA20_POLY1305            TLSv1.2    Kx=DHEPSK      Au=PSK     Enc=CHACHA20/POLY1305(256)     Mac=AEAD               
      0xCC,0xAC - ECDHE-PSK-CHACHA20-POLY1305    TLS_ECDHE_PSK_WITH_CHACHA20_POLY1305          TLSv1.2    Kx=ECDHEPSK    Au=PSK     Enc=CHACHA20/POLY1305(256)     Mac=AEAD               
      ...
      0xCC,0xAB - PSK-CHACHA20-POLY1305          TLS_PSK_WITH_CHACHA20_POLY1305                TLSv1.2    Kx=PSK         Au=PSK     Enc=CHACHA20/POLY1305(256)     Mac=AEAD               
...
EOF
     ...
     while read TLS_CIPHER_HEXCODE[TLS_NR_CIPHERS] n TLS_CIPHER_OSSL_NAME[TLS_NR_CIPHERS] TLS_CIPHER_RFC_NAME[TLS_NR_CIPHERS] TLS_CIPHER_SSLVERS[TLS_NR_CIPHERS] TLS_CIPHER_KX[TLS_NR_CIPHERS] TLS_CIPHER_AUTH[TLS_NR_CIPHERS] enc[TLS_NR_CIPHERS] TLS_CIPHER_ENC TLS_CIPHER_EXPORT[TLS_NR_CIPHERS]; do
          TLS_NR_CIPHERS+=1
