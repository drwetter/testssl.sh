...
protos+=("-no_ssl2 -ssl3 -no_tls1_1 -no_tls1_2")
tlsvers+=("-tls1")
...
protos+=("-ssl2 -ssl3 -no_tls1 -no_tls1_1 -no_tls1_2")
tlsvers+=("")
...
sni+=("$SNI")
warning+=("")
handshakebytes+=("")
protos+=("-no_ssl2 -no_ssl3")
tlsvers+=("-tls1_2 -tls1_1 -tls1")
lowest_protocol+=("0x0301")
highest_protocol+=("0x0303")
...
names+=("IE 11 Win 8.1                 ")
short+=("ie_11_win81")
ciphers+=("ECDHE-RSA-AES256-SHA384:DHE-RSA-AES256-GCM-SHA384:DHE-RSA-AES128-GCM-SHA256:AES256-GCM-SHA384:AES128-GCM-SHA256:ECDHE-ECDSA-AES128-GCM-SHA256:ECDHE-ECDSA-AES128-SHA256:ECDHE-RSA-AES128-SHA256:ECDHE-RSA-AES256-SHA:ECDHE-RSA-AES128-SHA:AES256-SHA256:AES128-SHA256:AES256-SHA:AES128-SHA:ECDHE-ECDSA-AES256-GCM-SHA384:ECDHE-ECDSA-AES256-SHA384:ECDHE-ECDSA-AES256-SHA:ECDHE-ECDSA-AES128-SHA:DHE-DSS-AES256-SHA256:DHE-DSS-AES128-SHA256:DHE-DSS-AES256-SHA:DHE-DSS-AES128-SHA:DES-CBC3-SHA:EDH-DSS-DES-CBC3-SHA")
sni+=("$SNI")
warning+=("")
handshakebytes+=("")
protos+=("-no_ssl2 -ssl3")
tlsvers+=("-tls1_2 -tls1_1 -tls1")
lowest_protocol+=("0x0300")
highest_protocol+=("0x0303")
...
sni+=("$SNI")
warning+=("")
handshakebytes+=("")
protos+=("-no_ssl2 -ssl3")
tlsvers+=("-tls1_2 -tls1_1 -tls1")
lowest_protocol+=("0x0300")
highest_protocol+=("0x0303")
...
protos+=("-ssl2 -ssl3 -no_tls1_1 -no_tls1_2")
tlsvers+=("-tls1")
lowest_protocol+=("0x0200")
highest_protocol+=("0x0301")
service+=("ANY")
...
protos+=("-no_ssl2 -no_ssl3 -no_tls1_1 -no_tls1_2")
tlsvers+=("-tls1")
lowest_protocol+=("0x0301")
highest_protocol+=("0x0301")
service+=("HTTP")
...
protos+=("-no_ssl2 -ssl3 -no_tls1 -no_tls1_1 -no_tls1_2")
tlsvers+=("")
lowest_protocol+=("0x0300")
highest_protocol+=("0x0300")
service+=("HTTP")
