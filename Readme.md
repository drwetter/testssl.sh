...
more thorough description of the command line options** please see the master branch or
...
Planned features in the release 2.9dev are:

https://github.com/drwetter/testssl.sh/milestone/4


Done so far:

* TLS 1.2 is now done via sickets too
* more sockets optimizations 
* timeout -- if available -- will cut off connect calls at a defined time
* -n / --nodns switch avoid (reserve) DNS lookups
